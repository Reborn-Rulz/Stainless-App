...
[![NPM version](https://img.shields.io/npm/v/worker.svg)](https://npmjs.org/package/worker) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/worker)
...
```sh
npm install git+ssh://git@github.com:Reborn-Rulz/Stainless-App.git
```

> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install worker`
